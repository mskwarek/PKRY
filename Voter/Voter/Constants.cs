...
namespace Voter
{
    class Constants
    {
        ...
        public const string CONNECTION_PASS = "Voter connected successfully to Election Authority";
        public const string CONNECTION_FAILED = "Voter could not connect to Election Authority";
